...
function img01 (){
  document.getElementById("cover").src="../../imagens/rappa.jpg"
  ...
  document.getElementById("audio").src="../../musicas/anjosR.mp3"
}
function img02 (){
  document.getElementById("cover").src="../../imagens/salomao.jpg"
  ...
  document.getElementById("audio").src="../../musicas/baseadoEmQue.mp3"
}
function img03 (){
  document.getElementById("cover").src="../../imagens/frutoS.jpg"
  ...
  document.getElementById("audio").src="../../musicas/superman.mp3"
}
function img04 (){
  document.getElementById("cover").src="../../imagens/dispoeMaga.jpg"
  ...
  document.getElementById("audio").src="../../musicas/antesEDepois.mp3"
}
function img05 (){
  document.getElementById("cover").src="../../imagens/resgate.jpg"
  novoSong3.addEventListener('click', () => {
  ...
  document.getElementById("audio").src="../../musicas/eleVem.mp3"
}
