...
function img01 (){
  document.getElementById("cover").src="../../imagens/nelly.jpg"
  ...
  document.getElementById("audio").src="../../musicas/dilemmaN.mp3"
}
function img02 (){
  document.getElementById("cover").src="../../imagens/akon.jpg"
  ...
  document.getElementById("audio").src="../../musicas/dontMatter.mp3"
}
function img03 (){
  document.getElementById("cover").src="../../imagens/50cent.jpg"
  ...
  document.getElementById("audio").src="../../musicas/inDaClub.mp3"
}
function img04 (){
  document.getElementById("cover").src="../../imagens/souljaB.jpg"
  ...
  document.getElementById("audio").src="../../musicas/crankSB.mp3"
}
function img05 (){
  document.getElementById("cover").src="../../imagens/deitrickH.jpg"
  novoSong3.addEventListener('click', () => {
  ...
  document.getElementById("audio").src="../../musicas/beLikeJesus.mp3"
}
